...
if meshformat_xml:
    mesh = df.Mesh('./meshes/ellipsoid/ellipsoid.xml')
    boundaries = df.MeshFunction('size_t',mesh,'./meshes/ellipsoid/ellipsoid_facet_region.xml')
    fibers = np.fromfile('./meshes/ellipsoid/ellipsoid.lon',dtype=float, sep=" ")
